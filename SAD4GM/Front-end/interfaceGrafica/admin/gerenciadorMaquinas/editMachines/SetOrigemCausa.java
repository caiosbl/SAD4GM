 ...
 *
 */
public class SetOrigemCausa extends Main {
	 ...
	 * Create the frame.
	 */
	public SetOrigemCausa(String idUser, int xLocation, int yLocation, int chaveOrigemCausa) {
		...
		lblSubsistema.setBounds(30, 46, 229, 29);
