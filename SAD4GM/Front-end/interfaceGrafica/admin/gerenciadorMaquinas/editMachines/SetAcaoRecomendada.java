 ...
 *
 */
public class SetAcaoRecomendada extends Main {
	 ...
	 * Create the frame.
	 */
	public SetAcaoRecomendada(String idUser, int xLocation, int yLocation, int chaveAcaoRecomendada) {
		...
		btnVoltar.setSelectedIcon(new ImageIcon(SetAcaoRecomendada.class.getResource("/Resources/icon/return-selected.png")));
		btnVoltar.setIcon(new ImageIcon(SetAcaoRecomendada.class.getResource("/Resources/icon/back-btn.png")));
		...
		btnAtualizar.setSelectedIcon(new ImageIcon(SetAcaoRecomendada.class.getResource("/Resources/icon/update-selected.png")));
		btnAtualizar.setBackground(new Color(0,0,0,0));
		btnAtualizar.setIcon(new ImageIcon(SetAcaoRecomendada.class.getResource("/Resources/icon/update.png")));
		btnAtualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				if (isEmpty(nomeField.getText().trim())) {
					nomeField.setText(sistema.getNomeCausaPotencial(chaveAcaoRecomendada));
					descricaoPane.setText(sistema.getDescricaoCausaPotencial(chaveAcaoRecomendada));
					...
					String mensagem = "";
					mensagem += sistema.setNomeAcaoRecomendada(nomeField.getText().trim(), chaveAcaoRecomendada);
					mensagem += System.lineSeparator()
							+ sistema.setDescricaoAcaoRecomendada(descricaoPane.getText().trim(), chaveAcaoRecomendada);
		...
		nomeField.setText(sistema.getNomeAcaoRecomendada(chaveAcaoRecomendada));
		...
		lblEditar.setBounds(85, 20, 110, 29);
		...
		lblCausaPotencial.setBounds(18, 50, 262, 29);
