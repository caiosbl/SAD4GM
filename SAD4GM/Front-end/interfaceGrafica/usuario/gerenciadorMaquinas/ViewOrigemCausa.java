...
public class ViewOrigemCausa extends Main {
	 ...
	 * Create the frame.
	 */
	public ViewOrigemCausa(String id, int chaveOrigemCausa, int xLocation, int yLocation) {
		...
		btnVoltar.setSelectedIcon(new ImageIcon(ViewOrigemCausa.class.getResource("/Resources/icon/return-selected.png")));
		btnVoltar.setBackground(new Color(0,0,0,0));
		btnVoltar.setIcon(new ImageIcon(ViewOrigemCausa.class.getResource("/Resources/icon/back-btn.png")));
		...
		textPane.setText(sistema.getNomeOrigem(chaveOrigemCausa));
		...
		button.setIcon(new ImageIcon(ViewOrigemCausa.class.getResource("/Resources/icon/home-off.png")));
		button.setSelectedIcon(new ImageIcon(ViewOrigemCausa.class.getResource("/Resources/icon/home-on.png")));
		...
		button_1.setSelectedIcon(new ImageIcon(ViewOrigemCausa.class.getResource("/Resources/icon/my-data-on.png")));
		button_1.setIcon(new ImageIcon(ViewOrigemCausa.class.getResource("/Resources/icon/my-data-off.png")));
		...
		logoutBtn.setSelectedIcon(new ImageIcon(ViewOrigemCausa.class.getResource("/Resources/icon/logout-on.png")));
		logoutBtn.setIcon(new ImageIcon(ViewOrigemCausa.class.getResource("/Resources/icon/logout-off.png")));
		...
		label_1.setIcon(new ImageIcon(ViewOrigemCausa.class.getResource("/Resources/icon/navbar.png")));
