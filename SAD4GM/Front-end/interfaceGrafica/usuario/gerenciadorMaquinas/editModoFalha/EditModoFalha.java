 ...
 *
 */
public class EditModoFalha extends Main {
	...
	public EditModoFalha(String id, int xLocation, int yLocation, int chaveMaquina, int chaveSubsistema,
		...
		btnVoltar.setIcon(new ImageIcon(EditModoFalha.class.getResource("/Resources/icon/voltabut.png")));
		...
		logo.setIcon(new ImageIcon(EditModoFalha.class.getResource("/Resources/icon/sad4logosmall.png")));
		logo.setBounds(29, 40, 205, 74);
		desktopPane.add(logo);

		JLabel banner = new JLabel("");
		banner.setIcon(new ImageIcon(EditModoFalha.class.getResource("/Resources/icon/editModoFalha.png")));
